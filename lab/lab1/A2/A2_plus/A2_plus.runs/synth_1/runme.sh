...
HD_PWD='C:/Users/SJTU-Aqueous/Desktop/A2_plus/A2_plus/A2_plus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log A2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source A2_top.tcl
