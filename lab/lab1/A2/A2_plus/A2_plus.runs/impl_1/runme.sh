...
HD_PWD='C:/Users/SJTU-Aqueous/Desktop/A2_plus/A2_plus/A2_plus.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log A2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source A2_top.tcl -notrace
